        ...
        <div className="position-fixed bottom-0 end-0 p-4 d-flex flex-column gap-3" style={{ zIndex: 1000 }}>
            ...
            >
                <Button
                    ...
                    style={{ width: '60px', height: '60px', backgroundColor: '#25D366', border: 'none' }}
                    href="https://wa.me/919510766011"
                    target="_blank"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-whatsapp" viewBox="0 0 16 16" color="white">
