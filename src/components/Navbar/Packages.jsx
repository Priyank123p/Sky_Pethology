...
const Packages = () => {
        ...
        const fetchPackages = () => {
            Papa.parse(GOOGLE_SHEET_URL, {
                ...
                complete: (results) => {
                    ...
                    const validData = results.data.filter(pkg => pkg['Id'] && pkg['Packages-Name']);
    ...
    return (
        <div className="fade-in bg-white" style={{ minHeight: '100vh', paddingTop: '2%' }}>
            <Container className="py-4">
                <div className="text-center mb-5" data-aos="fade-up">
                    <Badge bg="primary" className="mb-2 px-3 py-2 rounded-pill bg-opacity-75 text-white" style={{ backgroundColor: '#4834d4' }}>Exclusive Offers</Badge>
                    <h2 className="fw-bold display-5 mb-3" style={{ color: '#2c3e50' }}>Our Health Packages</h2>
                    <p className="text-muted mx-auto lead" style={{ maxWidth: '700px', fontWeight: '500', fontSize: '1.1rem' }}>
                        Comprehensive health checkup packages designed to keep you and your family healthy.
                    </p>
                </div>
